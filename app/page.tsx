              ...
              <motion.div key="auth" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="flex flex-col gap-3">
                    <Button type="button" variant="outline" onClick={() => handleOAuth("google")} className="w-full bg-slate-900/30 border-border/50 hover:bg-slate-900/60 rounded-xl text-xs font-medium py-5 gap-2">
